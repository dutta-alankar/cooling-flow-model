...
time_start = start_avg*pc/1e5*freq
time_stop  = int(sys.argv[2])*pc/1e5*freq
data = [X/pc,]
...
plt.grid()
fig.suptitle(r'$\rm t/t_{cool,hot}\ \approx$ %.3f to %.3f'%((time_start/tcool), (time_stop/tcool)))
...
fig.suptitle(r'$\rm t/t_{cool,hot}\ \approx$ %.3f to %.3f'%((time_start/tcool), (time_stop/tcool)), y=0.9)
