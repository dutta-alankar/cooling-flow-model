...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct  9 00:38:54 2021
...
axs[0, 0].set_ylim(ymin=-3.2, ymax=-0.3)
axs[0, 0].set_xlim(xmin=-rightedge, xmax=rightedge)
...
axs[0, 1].set_ylim(ymin=2.7, ymax=3.5)
axs[0, 1].set_xlim(xmin=-rightedge, xmax=rightedge)
...
axs[0, 2].set_ylim(ymin=-85, ymax=20)
axs[0, 2].set_xlim(xmin=-rightedge, xmax=rightedge)
...
axs[1, 0].set_ylim(ymin=-4.2, ymax=0.5)
axs[1, 0].set_xlim(xmin=-rightedge, xmax=rightedge)
...
axs[1, 1].set_ylim(ymin=3.83, ymax=6.3)
axs[1, 1].set_xlim(xmin=-rightedge, xmax=rightedge)
...
axs[1, 2].grid()
#axs[1, 2].set_ylim(ymin=-6.5, ymax=8.8)
axs[1, 2].set_ylim(ymin=-0.3, ymax=0.25)
axs[1, 2].set_xlim(xmin=-rightedge, xmax=rightedge)
